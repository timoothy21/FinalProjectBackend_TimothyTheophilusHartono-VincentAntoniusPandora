...
<body>
   <section class="mt-3">
      ...
      <h4 class="text-center"> PT. Systeric - Bill </h4>
      <div class="row">
                  ...
                  <tr>
                     ...
                     <td style="width:70%">
                        <select name="vegitable" id="vegitable"  class="form-control">
                           ...
                           <option id={{$row->id}} value={{$row->name}} class="vegitable custom-select">
                              {{$row->name}}
                           </option>
                           @endforeach
                        </select>
            ...
            <tr>
               <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                     ...
                     <textarea class="form-control" style="height:100px" name="alamat" placeholder="Alamat"></textarea>
                  </div>
               </div>
            </tr>
            ...
            <div class="p-4">
               ...
               <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                     <p>Order No: <script>document.write(Math.floor(Math.random() * 100) + 1);</script> </p>
                  </div>
               </div>
               <div class="row">
                  </span>
      ...
      $('#add').on('click',function(){
         ...
         function billFunction()
         {
            ...
            $('#new').append(table)
               ...
               // Code for calculate tax of Subtoal 11% Tax Applied
                  var Tax = (total * 11) / 100;
